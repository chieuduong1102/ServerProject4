...
import com.example.restservice.controller.exceptions.IllegalOrphanException;
...
//		List<Image> list = ImageJpaController.findAllEntities();
//				
//                //create Category object from id, name, desc
//                Book book = new Category(id, name, list);
